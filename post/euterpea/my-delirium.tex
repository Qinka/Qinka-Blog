...
\paragraph{常规软件制作版本}
使用常规软件制作的版本的连接：\href{https://raw.githubusercontent.com/Qinka/Qinka-Blog/post-euterpea-dev/post/euterpea/music/My-delirium-qinka.mp3}{my-delirium-qinka.mp3}\footnote{此版本为50\%完成度的demo，且文件目前只能在 github 上。。。}
